<nav class="bg-white dark:bg-gray-800 shadow dark:shadow-gray-700 sticky top-0 z-50">
    <div class="max-w-6xl mx-auto px-4 py-4 flex items-center justify-between mmd:block">
        <div class="flex items-center justify-between gap-4">
            ...
            <div class="hidden mmd:flex items-center gap-3">
                @auth
                    ...
                    <nav class="flex items-center gap-2">
                        ...
                        <button type="button" data-theme-toggle class="inline-flex items-center gap-2 px-3 py-2 rounded-full border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 text-sm font-medium text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-indigo-200 dark:focus:ring-indigo-800 cursor-pointer" aria-pressed="false" aria-label="Thema wisselen">
                            <span data-theme-icon="light" class="h-4 w-4">
                            ...
                            <span data-theme-icon="dark" class="h-4 w-4 hidden">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="h-4 w-4">
    ...
    <div id="nav-menu" class="hidden mmd:hidden px-4 pb-4">
        @auth
            @if(auth()->user()->isAdmin())
