            ...
            <div class="mb-6">
                ...
                <div id="goals-container">
                    @foreach($goals as $index => $goal)
                        <div class="goal-row bg-gray-50 p-3 rounded mb-2">
                            <input type="hidden" name="goals[{{ $index }}][id]" value="{{ $goal->id }}">
                            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 mb-3">
                                <div>
                                    <label class="block text-xs text-gray-600 mb-1">Speler</label>
                                ...
                                <div>
                                    <label class="block text-xs text-gray-600 mb-1">Minuut</label>
                                    <input type="number" name="goals[{{ $index }}][minute]" value="{{ $goal->minute }}" class="w-full border rounded p-1 text-sm" min="0" max="120" placeholder="—">
                                </div>
                                <div>
                                ...
                                <div>
                                    <label class="block text-xs text-gray-600 mb-1">Assist</label>
                            ...
                            <div class="grid grid-cols-1 gap-3">
                                <div>
                                    <label class="block text-xs text-gray-600 mb-1">Notities</label>
