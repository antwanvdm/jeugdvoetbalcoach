<x-app-layout>
	<section class="mx-auto max-w-3xl px-6 py-16 text-center">
		...
		<h1 class="mt-4 text-2xl font-semibold text-gray-900">{{ __('Pagina niet gevonden') }}</h1>
		<p class="mt-2 text-gray-600">De pagina die je zoekt bestaat niet of is verplaatst.</p>
		<div class="mt-6">
