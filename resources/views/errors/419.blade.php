<x-app-layout>
	<section class="mx-auto max-w-3xl px-6 py-16 text-center">
		...
		<h1 class="mt-4 text-2xl font-semibold text-gray-900 dark:text-gray-100">{{ __('Pagina verlopen') }}</h1>
		<p class="mt-2 text-gray-600 dark:text-gray-300">Je sessie is verlopen. Vernieuw de pagina en probeer opnieuw.</p>
		<div class="mt-6">
