<x-app-layout>
    <div class="mb-4 text-sm text-gray-600 dark:text-gray-300">
        ...
        niet lukken, neem dan contact met ons op via het <a href="{{ route('home') }}#feedback" class="text-blue-600 dark:text-blue-400 hover:underline">feedbackformulier</a>.
    </div>
    ...
    <div class="mt-4 flex items-center justify-between">
        ...
        <div class="flex gap-3 items-center">
            <a href="{{ route('dashboard') }}" class="underline text-sm text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-gray-100 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                Naar dashboard
            </a>
            ...
            <form method="POST" action="{{ route('logout') }}" class="flex items-center">
                ...
                <button type="submit" class="underline text-sm text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-gray-100 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 cursor-pointer">
                    Uitloggen
                </button>
            </form>
        </div>
