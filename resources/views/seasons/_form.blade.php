<div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
    <div>
        ...
        <div class="flex items-center gap-2">
            <input type="number" name="year" id="season-year" value="{{ old('year', $season->year ?? '') }}" class="mt-1 block flex-1 border dark:border-gray-600 bg-white dark:bg-gray-700 dark:text-gray-100 p-2 rounded" min="2000" max="2100">
    ...
    <div>
        ...
        <input type="number" name="part" id="season-phase" min="1" max="4" value="{{ old('part', $season->part ?? 1) }}" class="mt-1 block w-full border dark:border-gray-600 bg-white dark:bg-gray-700 dark:text-gray-100 p-2 rounded" oninput="validatePhaseInput(this)">
    ...
    <div>
        ...
        <input type="date" name="start" value="{{ old('start', isset($season) ? $season->start->format('Y-m-d') : '') }}" class="mt-1 block w-full border dark:border-gray-600 bg-white dark:bg-gray-700 dark:text-gray-100 p-2 rounded scheme-light dark:scheme-dark">
        @error('start')
        <div class="text-red-600 dark:text-red-400 text-sm">{{ $message }}</div>@enderror
    </div>
    ...
    <div>
        ...
        <input type="date" name="end" value="{{ old('end', isset($season) ? $season->end->format('Y-m-d') : '') }}" class="mt-1 block w-full border dark:border-gray-600 bg-white dark:bg-gray-700 dark:text-gray-100 p-2 rounded scheme-light dark:scheme-dark">
        @error('end')
        <div class="text-red-600 dark:text-red-400 text-sm">{{ $message }}</div>@enderror
    </div>
    ...
    <div>
        ...
        <select name="formation_id" class="mt-1 block w-full border dark:border-gray-600 bg-white dark:bg-gray-700 dark:text-gray-100 p-2 rounded">
