    ...
    <div class="max-w-3xl mx-auto">
        ...
        <div class="bg-white p-4 shadow rounded mt-6">
            ...
            @if($season->share_token)
                <div class="mb-4">
                    <label class="block text-sm text-gray-600 mb-1">Deellink</label>
                    <div class="flex items-center gap-2">
                        <input
                            type="text"
                            readonly
                            value="{{ route('seasons.share', ['season' => $season, 'shareToken' => $season->share_token]) }}"
                            class="flex-1 border rounded p-2 bg-gray-50 text-sm"
                        >
                        <button
                            type="button"
            ...
            @else
                <p class="text-sm text-gray-600 mb-3">Nog geen deellink. Genereer een link om dit seizoen met ouders te delen.</p>
