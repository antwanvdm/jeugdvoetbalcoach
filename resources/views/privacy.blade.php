...
<x-app-layout>
    <section class="mx-auto max-w-4xl px-6 py-12">
        <h1 class="text-3xl font-bold text-gray-900 dark:text-gray-100 mb-6">Privacy</h1>
        <p class="text-gray-600 dark:text-gray-300 mb-8">Laatst bijgewerkt: {{ now()->format('d-m-Y') }}</p>

        <div class="prose prose-blue max-w-none space-y-8">
            <!-- Introductie -->
            <div>
                <h2 class="text-2xl font-semibold text-gray-900 dark:text-gray-100 mb-3">Inleiding</h2>
            ...
            <div>
                <h2 class="text-2xl font-semibold text-gray-900 dark:text-gray-100 mb-3">Welke gegevens verzamelen we?</h2>
                <h3 class="text-xl font-semibold text-gray-800 dark:text-gray-100 mt-4 mb-2">Account & teamgegevens</h3>
                <p class="text-gray-700 dark:text-gray-200 leading-relaxed mb-2">
                    Wanneer je een account aanmaakt, vragen we om:
                </p>
                <ul class="list-disc list-inside text-gray-700 dark:text-gray-200 space-y-1 ml-4">
                    <li>Je naam</li>
                    <li>E-mailadres (voor login en verificatie)</li>
                    <li>Wachtwoord (versleuteld opgeslagen)</li>
                </ul>
                <p class="text-gray-700 dark:text-gray-200 leading-relaxed mt-2">
                ...
                <h3 class="text-xl font-semibold text-gray-800 dark:text-gray-100 mt-4 mb-2">Contactformulier (feedback)</h3>
                <p class="text-gray-700 dark:text-gray-200 leading-relaxed">
                ...
                <h3 class="text-xl font-semibold text-gray-800 dark:text-gray-100 mt-4 mb-2">Google Analytics (GA4)</h3>
                <p class="text-gray-700 dark:text-gray-200 leading-relaxed">
                ...
                <p class="text-gray-700 dark:text-gray-200 leading-relaxed mt-2">
                    ...
                    <a href="https://policies.google.com/privacy" target="_blank" rel="noopener noreferrer" class="text-blue-600 dark:text-blue-300 hover:underline">privacybeleid van Google</a>.
                </p>
            </div>

            <!-- Hoe gebruiken we je gegevens -->
            <div>
                <h2 class="text-2xl font-semibold text-gray-900 dark:text-gray-100 mb-3">Hoe gebruiken we je gegevens?</h2>
                <ul class="list-disc list-inside text-gray-700 dark:text-gray-200 space-y-2 ml-4">
            ...
            <!-- Bewaartermijn -->
            <div>
                <h2 class="text-2xl font-semibold text-gray-900 dark:text-gray-100 mb-3">Hoe lang bewaren we je gegevens?</h2>
                <p class="text-gray-700 dark:text-gray-200 leading-relaxed">
            ...
            <!-- Delen met derden -->
            <div>
                <h2 class="text-2xl font-semibold text-gray-900 dark:text-gray-100 mb-3">Delen we je gegevens met derden?</h2>
                <p class="text-gray-700 dark:text-gray-200 leading-relaxed">
            ...
            <!-- Beveiliging -->
            <div>
                <h2 class="text-2xl font-semibold text-gray-900 dark:text-gray-100 mb-3">Hoe beveiligen we je gegevens?</h2>
                <p class="text-gray-700 dark:text-gray-200 leading-relaxed">
            ...
            <!-- Je rechten -->
            <div>
                <h2 class="text-2xl font-semibold text-gray-900 dark:text-gray-100 mb-3">Wat zijn je rechten?</h2>
                <p class="text-gray-700 dark:text-gray-200 leading-relaxed">
                ...
                <p class="text-gray-700 dark:text-gray-200 leading-relaxed mt-2">
                    Voor vragen over je privacy of om een van deze rechten uit te oefenen, kun je contact opnemen via het <a href="{{ route('home') }}#feedback" class="text-blue-600 dark:text-blue-300 hover:underline">feedbackformulier</a> op de homepage.
                </p>
            </div>

            <!-- Cookies -->
            <div>
                <h2 class="text-2xl font-semibold text-gray-900 dark:text-gray-100 mb-3">Cookies</h2>
                <p class="text-gray-700 dark:text-gray-200 leading-relaxed">
            ...
            <!-- Wijzigingen -->
            <div>
                <h2 class="text-2xl font-semibold text-gray-900 dark:text-gray-100 mb-3">Wijzigingen in deze privacyverklaring</h2>
                <p class="text-gray-700 dark:text-gray-200 leading-relaxed">
            ...
            <!-- Contact -->
            <div>
                <h2 class="text-2xl font-semibold text-gray-900 dark:text-gray-100 mb-3">Contact</h2>
                <p class="text-gray-700 dark:text-gray-200 leading-relaxed">
                    Voor vragen over privacy, gegevensverwerking of deze verklaring kun je contact opnemen via:
                </p>
                <ul class="list-none text-gray-700 dark:text-gray-200 space-y-1 mt-2">
                    <li><strong>Feedbackformulier:</strong> <a href="{{ route('home') }}#feedback" class="text-blue-600 dark:text-blue-300 hover:underline">Homepage</a></li>
                </ul>
            </div>

            <!-- Open Source -->
            <div class="bg-blue-50 dark:bg-blue-900 border border-blue-200 dark:border-blue-700 rounded-lg p-6 mt-8">
                <h3 class="text-lg font-semibold text-blue-900 dark:text-blue-100 mb-2">Open Source & Transparantie</h3>
                <p class="text-blue-800 dark:text-blue-300 text-sm leading-relaxed">
                    ...
                    <a href="https://github.com/antwanvdm/jeugdvoetbalcoach" target="_blank" rel="noopener noreferrer" class="underline font-medium text-blue-700 dark:text-blue-200">GitHub</a>.
