        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div class="md:col-span-2">
                ...
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <a href="{{ route('positions.index') }}" class="flex items-center gap-4 p-4 bg-white rounded shadow hover:shadow-md">
                ...
                <div class="bg-white p-4 shadow rounded mt-4">
                    <p>
                        VVOR Team Manager is ontwikkeld voor voetbalverenigingen die hun teammanagement willen professionaliseren. Ideaal voor trainers van JO8 t/m JO12 waar spelers in 4 kwarten spelen en iedereen evenveel speel (en keep!)tijd
