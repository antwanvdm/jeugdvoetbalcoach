...
<x-app-layout title="{{ config('app.name') }} – Slim teammanagement voor jeugdcoaches">
    ...
    <section class="relative isolate overflow-hidden">
        ...
        <div class="mx-auto max-w-5xl px-6 py-20 text-center">
            ...
            <div class="mt-8 flex flex-col sm:flex-row gap-4 justify-center">
                @auth
                    <a href="{{ route('dashboard') }}" class="inline-flex items-center justify-center gap-2 rounded-md bg-blue-600 px-8 py-3 text-white font-semibold shadow dark:shadow-gray-700 hover:bg-blue-500 transition">
                ...
                @else
                    <a href="{{ route('register') }}" class="inline-flex items-center justify-center gap-2 rounded-md bg-blue-600 px-8 py-3 text-white font-semibold shadow dark:shadow-gray-700 hover:bg-blue-500 transition">Registreren</a>
    ...
    <section class="mx-auto max-w-6xl px-6 py-16">
        ...
        @if(session('feedback_success'))
            <div class="mb-6 rounded-lg bg-green-50 dark:bg-green-900 p-4 border border-green-200 dark:border-green-700">
                <div class="flex">
                    ...
                    <p class="ml-3 text-sm text-green-800 dark:text-green-200">{{ session('feedback_success') }}</p>
                </div>
            </div>
        @endif

        <h2 class="text-2xl font-bold tracking-tight text-gray-900 dark:text-gray-100 mb-6">Wat kan het systeem voor jou doen?</h2>
        <div class="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
            <!-- Spelers beheer -->
            <div class="bg-white dark:bg-gray-800 rounded-xl border shadow-sm p-6 text-center hover:shadow-md dark:shadow-gray-700 transition">
                ...
                <h3 class="font-semibold text-gray-900 dark:text-gray-100 mb-2">Spelersbeheer</h3>
                <p class="text-sm text-gray-600 dark:text-gray-300">Voeg spelers toe met fysiek niveau en voorkeursposities</p>
            </div>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl border shadow-sm p-6 text-center hover:shadow-md dark:shadow-gray-700 transition">
                ...
                <h3 class="font-semibold text-gray-900 dark:text-gray-100 mb-2">Formatie-keuze</h3>
                <p class="text-sm text-gray-600 dark:text-gray-300">Kies uit presets of maak eigen formaties per seizoen</p>
            </div>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl border shadow-sm p-6 text-center hover:shadow-md dark:shadow-gray-700 transition">
                ...
                <h3 class="font-semibold text-gray-900 dark:text-gray-100 mb-2">Automatische Line-ups</h3>
                <p class="text-sm text-gray-600 dark:text-gray-300">Genereer eerlijke opstellingen met slimme rotatie algoritmes</p>
            </div>
    ...
    <section class="mx-auto max-w-6xl px-6 pb-16">
        <h2 class="text-2xl font-bold tracking-tight text-gray-900 dark:text-gray-100 mb-6">Hoe het werkt</h2>
            ...
            <div class="grid lg:grid-cols-2 gap-8 items-center">
                <div class="order-2 lg:order-1">
                    <div class="flex items-center gap-3 mb-4">
                        ...
                        <h3 class="text-xl font-semibold text-gray-900 dark:text-gray-100">Stel je team samen</h3>
                    </div>
                    <p class="text-gray-600 dark:text-gray-300 mb-4">Maak een team aan, nodig andere coaches uit en voeg je spelers toe. Geef aan wat hun fysieke niveau is en op welke posities ze het liefst spelen.</p>
                ...
                <div class="order-1 lg:order-2">
                    <div class="screenshot-carousel relative" data-carousel="step1">
                        <div class="carousel-slides relative aspect-video rounded-xl overflow-hidden shadow-lg dark:shadow-gray-700">
            ...
            <div class="grid lg:grid-cols-2 gap-8 items-center">
                ...
                <div>
                    <div class="flex items-center gap-3 mb-4">
                        ...
                        <h3 class="text-xl font-semibold text-gray-900 dark:text-gray-100">Kies je formatie en seizoen</h3>
                    </div>
                    <p class="text-gray-600 dark:text-gray-300 mb-4">Definieer een seizoensfase en kies de formatie waarin je wilt spelen. Gebruik standaard presets of maak je eigen formaties aan.</p>
                    <ul class="space-y-2 text-sm text-gray-600 dark:text-gray-300">
                        <li class="flex items-start gap-2">
                            <svg class="w-5 h-5 text-green-600 dark:text-green-400 shrink-0 mt-0.5" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                                <path d="m5 13 4 4L19 7"/>
                            </svg>
            ...
            <div class="grid lg:grid-cols-2 gap-8 items-center">
                <div class="order-2 lg:order-1">
                    <div class="flex items-center gap-3 mb-4">
                        ...
                        <h3 class="text-xl font-semibold text-gray-900 dark:text-gray-100">Genereer automatisch je line-up</h3>
                    </div>
                    <p class="text-gray-600 dark:text-gray-300 mb-4">Plan een wedstrijd en laat het systeem een eerlijke opstelling genereren. Het algoritme zorgt voor balans in speeltijd, posities en keeperrotatie.</p>
                    <ul class="space-y-2 text-sm text-gray-600 dark:text-gray-300">
                        <li class="flex items-start gap-2">
                            <svg class="w-5 h-5 text-purple-600 shrink-0 mt-0.5" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                                <path d="m5 13 4 4L19 7"/>
                            </svg>
    ...
    <section class="mx-auto max-w-4xl px-6 pb-16">
        <div class="bg-gradient-to-br from-blue-50 to-white dark:from-gray-800 dark:to-gray-900 rounded-xl border dark:border-gray-700 shadow-sm p-8 md:p-12">
            <div class="">
                <svg class="w-8 h-8 text-blue-600 dark:text-blue-400 mb-4" fill="currentColor" viewBox="0 0 24 24">
                    <path
                        d="M14.017 21v-7.391c0-5.704 3.731-9.57 8.983-10.609l.995 2.151c-2.432.917-3.995 3.638-3.995 5.849h4v10h-9.983zm-14.017 0v-7.391c0-5.704 3.748-9.57 9-10.609l.996 2.151c-2.433.917-3.996 3.638-3.996 5.849h3.983v10h-9.983z"/>
                </svg>
                <p class="text-gray-700 dark:text-gray-200 text-lg leading-relaxed mb-6">
                    Als beginnend jeugdcoach van <a href="https://www.vvor.nl/" target="_blank" class="inline-flex items-center gap-1 text-blue-600 hover:text-blue-700 dark:text-blue-400 transition">VVOR
                ...
                <div class="border-t pt-4 flex gap-4 items-center">
                    ...
                    <div>
                        <p class="font-semibold text-gray-900 dark:text-gray-100">Antwan van der Mooren</p>
                        <p class="text-sm text-gray-600 dark:text-gray-300">Ontwikkelaar & Jeugdcoach</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="mx-auto max-w-6xl px-6 pb-16">
        <h2 class="text-2xl font-bold tracking-tight text-gray-900 dark:text-gray-100 mb-6">Wil je bijdragen?</h2>
        <p class="text-gray-600 dark:text-gray-300 mb-8 max-w-3xl">Dit project is open source en verwelkomt bijdragen van de community. Of je nu een bug vindt, een feature wilt toevoegen, of de servers draaiende wilt houden.</p>
        <div class="grid gap-6 md:grid-cols-2">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl border shadow-sm p-6 hover:shadow-md dark:shadow-gray-700 transition">
                <div class="flex items-start gap-4">
                    <div class="shrink-0">
                        <svg class="w-12 h-12 text-gray-900 dark:text-gray-100" fill="currentColor" viewBox="0 0 24 24">
                            <path
                    ...
                    <div class="flex-1">
                        <h3 class="font-semibold text-gray-900 dark:text-gray-100 mb-2">Code bijdragen via GitHub</h3>
                        <p class="text-sm text-gray-600 dark:text-gray-300 mb-4">Vind je een bug of heb je een goed idee? Open een issue of stuur een pull request. Alle hulp is welkom!</p>
                        <a href="https://github.com/antwanvdm/jeugdvoetbalcoach" target="_blank" rel="noopener noreferrer" class="inline-flex items-center gap-2 text-sm font-medium text-blue-600 hover:text-blue-700 dark:text-blue-400">
    ...
    <section class="mx-auto max-w-6xl px-6 pb-16" id="feedback">
        <h2 class="text-2xl font-bold tracking-tight text-gray-900 dark:text-gray-100 mb-6">Feedback of fout gevonden?</h2>
        <p class="text-gray-600 dark:text-gray-300 mb-8 max-w-3xl">Mis je clubgegevens of heb je andere feedback? Laat het weten!</p>
        <div class="bg-white dark:bg-gray-800 rounded-xl border shadow-sm p-8">
            ...
            <form action="{{ route('home.feedback') }}" method="POST" class="space-y-6">
                ...
                <div class="grid gap-6 md:grid-cols-2">
                    <div>
                        <label for="name" class="block text-sm font-medium text-gray-700 dark:text-gray-200 mb-2">Naam</label>
                        <input type="text" name="name" id="name" value="{{ old('name') ?? auth()?->user()?->name }}" required class="w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 shadow-sm focus:border-blue-500 focus:ring-blue-500 @error('name') border-red-300
                        @enderror">
                        @error('name')
                    ...
                    <div>
                        <label for="email" class="block text-sm font-medium text-gray-700 dark:text-gray-200 mb-2">E-mail</label>
                        <input type="email" name="email" id="email" value="{{ old('email') ?? auth()?->user()?->email }}" required class="w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 shadow-sm focus:border-blue-500 focus:ring-blue-500 @error('email')
                ...
                <div>
                    <label for="subject" class="block text-sm font-medium text-gray-700 dark:text-gray-200 mb-2">Onderwerp</label>
                    <select name="subject" id="subject" required class="w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 shadow-sm focus:border-blue-500 focus:ring-blue-500 @error('subject') border-red-300 @enderror">
                ...
                <div>
                    <label for="message" class="block text-sm font-medium text-gray-700 dark:text-gray-200 mb-2">Bericht</label>
                    <textarea name="message" id="message" rows="5" required class="w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 shadow-sm focus:border-blue-500 focus:ring-blue-500 @error('message') border-red-300 @enderror">{{ old('message') }}</textarea>
                    @error('message')
                    <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="flex justify-end">
                    <button type="submit" class="inline-flex items-center gap-2 rounded-lg bg-blue-600 px-6 py-3 text-white font-semibold shadow dark:shadow-gray-700 hover:bg-blue-500 transition cursor-pointer">
    ...
    <!-- Call To Action -->
    <section class="mx-auto bg-blue-600 px-8 py-10 text-center shadow-md dark:shadow-gray-700">
        @auth
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center">
                <a href="{{ route('dashboard') }}" class="px-7 py-3 rounded-md bg-white dark:bg-gray-800 text-blue-700 dark:text-blue-400 font-semibold shadow dark:shadow-gray-700 hover:bg-blue-50 dark:bg-blue-900">
                    @if(auth()->user()->isAdmin())
                        Ga naar het Admin Dashboard
                    @else
                        Ga naar je overzicht voor {{ $currentTeam->opponent->name }}
        ...
        @else
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center">
                <a href="{{ route('register') }}" class="px-7 py-3 rounded-md bg-white dark:bg-gray-800 text-blue-700 dark:text-blue-400 font-semibold shadow dark:shadow-gray-700 hover:bg-blue-50 dark:bg-blue-900">Gratis Registreren</a>
